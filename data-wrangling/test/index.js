...
const TESTS = [
    {
        ...
        fn: async function () {
            ...
            errors.push(is(normalizedData, pub => pub.Persons[0].Order === 1 && pub.Persons[0].PersonData.FirstName === "Fejk" && pub.Persons[0].PersonData.LastName === "Fejksson"))
            errors.push(is(normalizedData, pub => pub.Persons[0].Organizations[0].OrganizationData.OrganizationParents[0].ParentOrganizationData.NameSwe === "Fejkuniversitet"))
            errors.push(is(normalizedData, pub => pub.Persons[0].Organizations[0].OrganizationData.OrganizationParents[0].ParentOrganizationData.NameEng === "Fake University"))
            errors.push(is(normalizedData, pub => pub.Persons[0].Organizations[0].OrganizationData.NameSwe === "Institutionen f&#246;r tester som är fejk"))
            errors.push(is(normalizedData, pub => pub.Persons[0].Organizations[0].OrganizationData.NameEng === "Department of testing that is fake"))
            errors.push(is(normalizedData, pub => pub.Persons[0].Organizations[0].OrganizationData.Identifiers.some(idObj => idObj.Type.Value === "SWEPUB_AFF_ID" && idObj.Value === "fejku.lib.chalmers.se/0001")))
            errors.push(is(normalizedData, pub => pub.Persons[1].Organizations[0].OrganizationData.OrganizationParents[0].ParentOrganizationData.NameSwe === "Fejkuniversitet"))
            errors.push(is(normalizedData, pub => pub.Persons[1].Organizations[0].OrganizationData.OrganizationParents[0].ParentOrganizationData.NameEng === "Fake University"))
            errors.push(is(normalizedData, pub => pub.Persons[1].Organizations[0].OrganizationData.NameSwe === "Institutionen f&#246;r tester som är ganska fejk"))
            errors.push(is(normalizedData, pub => pub.Persons[1].Organizations[0].OrganizationData.NameEng === "Department of testing that is pretty fake"))
            errors.push(is(normalizedData, pub => pub.Persons[1].Order === 2 && pub.Persons[1].PersonData.FirstName === "Fjek" && pub.Persons[1].PersonData.LastName === "Fjeksson" && pub.Persons[1].PersonData.BirthYear === 1972))
            errors.push(is(normalizedData, pub => pub.Persons[1].Organizations[0].OrganizationData.Identifiers.some(idObj => idObj.Type.Value === "SWEPUB_AFF_ID" && idObj.Value === "fejku.lib.chalmers.se/0002")))
            errors.push(is(normalizedData, pub => pub.Persons[2].Order === 3 && pub.Persons[2].PersonData.FirstName === "Anon" && pub.Persons[2].PersonData.LastName === "Fejko"))
            errors.push(is(normalizedData, pub => pub.Persons[3].Order === 4 && pub.Persons[3].PersonData.FirstName === "Nymus" && pub.Persons[3].PersonData.LastName === "Fjeko"))
    ...
    },
    {
        ...
        fn: async function () {
            ...
            errors.push(is(findDiffsResponse.diffs, "length", 6))
        ...
        name: "Find differences SWEPUB_GU, all in query, no hit",
        fn: async function () {
            let response = await fetch("data/1.xml")
            let textData = await response.text()
            let normalizedData = this.normalizeSwepub(textData, "SWEPUB_GU")
            ...
            let errors = []
            errors.push(is(nestedShouldQueryArr, arr => arr[0]?.bool?.must[0]?.term["Identifiers.Type.Value.keyword"]?.value === "GUP_ID" &&       arr[0]?.bool?.must[1]?.term["Identifiers.Value.keyword"]?.value === "12345"))
            errors.push(is(nestedShouldQueryArr, arr => arr[1]?.bool?.must[0]?.term["Identifiers.Type.Value.keyword"]?.value === "PUBMED_ID" && arr[1]?.bool?.must[1]?.term["Identifiers.Value.keyword"]?.value === "12345678"))
            errors.push(is(nestedShouldQueryArr, arr => arr[2]?.bool?.must[0]?.term["Identifiers.Type.Value.keyword"]?.value === "DOI" &&       arr[2]?.bool?.must[1]?.term["Identifiers.Value.keyword"]?.value === "10.1234/fejk.1234"))
            errors.push(is(nestedShouldQueryArr, arr => arr[3]?.bool?.must[0]?.term["Identifiers.Type.Value.keyword"]?.value === "WOS_ID" &&    arr[3]?.bool?.must[1]?.term["Identifiers.Value.keyword"]?.value === "123456789098765"))
            errors.push(is(nestedShouldQueryArr, arr => arr[4]?.bool?.must[0]?.term["Identifiers.Type.Value.keyword"]?.value === "SCOPUS_ID" && arr[4]?.bool?.must[1]?.term["Identifiers.Value.keyword"]?.value === "12345678909"))
